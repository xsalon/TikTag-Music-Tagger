...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.setMinimumSize(QtCore.QSize(340, 420))
        Dialog.setMaximumSize(QtCore.QSize(340, 420))
        ...
        self.groupBoxFingerprint = QtWidgets.QGroupBox(self.onlineSettings)
        self.groupBoxFingerprint.setObjectName("groupBoxFingerprint")
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(self.groupBoxFingerprint)
        self.verticalLayout_4.setObjectName("verticalLayout_4")
        self.checkBoxFingerprint = QtWidgets.QCheckBox(self.groupBoxFingerprint)
        self.checkBoxFingerprint.setObjectName("checkBoxFingerprint")
        self.verticalLayout_4.addWidget(self.checkBoxFingerprint)
        self.verticalLayout_2.addWidget(self.groupBoxFingerprint)
        self.tabWidget.addTab(self.onlineSettings, "")
        self.generalSettings = QtWidgets.QWidget()
        self.generalSettings.setEnabled(False)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.groupBoxFingerprint.setTitle(_translate("Dialog", "AcoustID"))
        self.checkBoxFingerprint.setText(_translate("Dialog", "Enable"))
